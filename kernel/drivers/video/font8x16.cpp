/* ===========================================================================
 * BOLT OS - 8x16 Bitmap Font Implementation
 * Clean, modern VGA-style font
 * =========================================================================== */
...
// 8x16 font data - cleaner looking glyphs (ASCII 32-127)
// Each character is 16 bytes (16 rows of 8 pixels)
const u8 Font8x16::font_data[] = {
    // Space (32)
...
const u8* Font8x16::get_glyph(char c) {
    if (c < 32 || c > 126) {
        c = '?';  // Unknown char
    }
    return &font_data[(c - 32) * 16];
}
